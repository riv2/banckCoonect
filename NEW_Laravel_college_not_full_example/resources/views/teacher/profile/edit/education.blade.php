<div class="form-group{{ $errors->has('education_document[level]') ? ' has-error' : '' }}">
    <label for="education_document[level]" class="col-md-4 control-label">{{__('Education')}}</label>
    <div class="col-md-6">
...
<div id="educationData" style="@if(!($educationDocument && $educationDocument->level))display: none; @endif">
    <div class="field_all form-group{{ $errors->has('education_document[doc_number]') ? ' has-error' : '' }}">
        <label for="education_document[doc_number]" class="col-md-4 control-label">{{__('Number')}}</label>
    ...
    <div class="field_all form-group{{ $errors->has('education_document[doc_series]') ? ' has-error' : '' }}">
        <label for="education_document[doc_series]" class="col-md-4 control-label">{{__('Series')}}</label>
    ...
    <div class="field_all form-group{{ $errors->has('education_document[institution_name]') ? ' has-error' : '' }}">
        <label for="education_document[institution_name]" class="col-md-4 control-label">{{__('Institution name')}}</label>
    ...
    <div class="field_all form-group{{ $errors->has('education_document[date]') ? ' has-error' : '' }}">
        <label for="education_document[date]" class="col-md-4 control-label">{{__('Issue date')}}</label>
    ...
    <div class="field_all form-group{{ $errors->has('education_document[city]') ? ' has-error' : '' }}">
        <label for="education_document[city]" class="col-md-4 control-label">{{__('City of issue')}}</label>
    ...
    <div class="field_all form-group{{ $errors->has('education_document[supplement_file]') ? ' has-error' : '' }}">
        <label for="education_document[supplement_file]" class="col-md-4 control-label">{{__('Diploma supplement')}}</label>
    ...
    >
        <label for="education_document[speciality]" class="col-md-4 control-label">{{__('Specialty')}}</label>
    ...
    <div class="field_vocational form-group{{ $errors->has('education_document[institution_type]') ? ' has-error' : '' }}"
         style="@if($educationDocument && $educationDocument->level != \App\UserEducationDocument::LEVEL_SECONDARY_SPECIAL)display: none; @endif"
    >
        <label for="education_document[institution_type]" class="col-md-4 control-label">{{__('Type of educational institution')}}</label>
        <div class="col-md-6">
    ...
    >
        <label for="education_document[degree]" class="col-md-4 control-label">{{__('Degree')}}</label>
    ...
    <div class="field_all form-group{{ $errors->has('education_document[specialization]') ? ' has-error' : '' }}">
        <label for="education_document[specialization]" class="col-md-4 control-label">{{__('Specialization')}}</label>
    ...
    <div class="field_all form-group">
        <label for="education_document[kz_holder]" class="col-md-4 control-label">{{__('Issued in Kazakhstan')}}</label>
        <div class="col-md-6">
            <div class="checkbox">
                <label>
    ...
    >
        <div class="field_all form-group{{ $errors->has('education_document[nostrification]') ? ' has-error' : '' }}">
            <label for="education_document[nostrification]" class="col-md-4 control-label">{{__('Nostrification')}}</label>
        ...
        <div class="field_all form-group{{ $errors->has('education_document[nostrification_file]') ? ' has-error' : '' }}">
            <label for="education_document[nostrification_file]" class="col-md-4 control-label"> </label>
