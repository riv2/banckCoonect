...
@section("content")
    <div id="main">
        <div class="page-header">
            <h2>{{ isset($info) ? 'Редактировать' : 'Добавить новость' }}</h2>

            <a href="{{ route('admin.news.get') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Назад</a>
        </div>
        ...
        <div class="panel panel-default panel-shadow" style="border-radius: 0px 5px 5px 5px;">
            <div class="panel-body">
                <form action="{{ route('admin.news.store', ['info_id' => $info->id ?? 0]) }}" method="post" name="info" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
