            ...
            <div class="form-group padding-t15 col-md-12">
                <div class="col-md-12">
                    ...
                    <div class="field_all form-group">
                        ...
                        <div class="col-md-12">
                            <input id="numeducation" type="text" class="form-control" name="numeducation" value="{{ $mgApplications->numeducation ?? '' }}" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="field_all form-group">
                        ...
                        <div class="col-md-12">
                            <input id="sereducation" type="text" class="form-control" name="sereducation" value="{{ $mgApplications->sereducation ?? '' }}" required autofocus>
                        </div>
                    </div>
-
                    <div class="field_all form-group">
                        ...
                        <div class="col-md-12">
                            <input id="nameeducation" type="text" class="form-control" name="nameeducation" value="{{ $mgApplications->nameeducation ?? '' }}" required autofocus>
                        </div>
                    </div>
                    ...
                    <div class="field_all form-group">
                        ...
                        <div class="col-md-12">
                            <input id="dateeducation" type="date" class="form-control" name="dateeducation" value="{{ $mgApplications->dateeducation ?? '' }}" required autofocus maxlength="9">
                        </div>
                    </div>
                    ...
                    <div class="field_all form-group">
                        ...
                        <div class="col-md-12">
                            <input id="cityeducation" type="text" class="form-control" name="cityeducation" value="{{ $mgApplications->cityeducation ?? '' }}" required autofocus >
                        </div>
                    </div>
