...
<div class="form-group">
    ...
    <student-education-block name="education-block" v-bind:active="true">
        <div class="col-md-12 subform">
            ...
            <div class="form-group padding-t15 col-md-12">
                <div class="col-md-12">
                    ...
                    <div v-if="educationLevel" class="col-md-12 subform">
                                ...
                                <student-document-option name="diploma" v-bind:active="true">
                                    <div class="subform col-md-12">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <input id="diploma_photo" type="file" accept=".jpg, .png, .gif, .webp" class="form-control" name="diploma_photo" value="" @change="checkImageValid('diploma_photo')" required autofocus>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <student-document-option name="diploma_supplement" v-bind:active="true">
                                    <div class="subform col-md-12">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            <input id="atteducation" type="file" accept=".jpg, .png, .gif, .webp" class="form-control" name="atteducation" value="" @change="checkImageValid('atteducation')" required autofocus>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <input id="atteducation_back" type="file" accept=".jpg, .png, .gif, .webp" class="form-control" name="atteducation_back" @change="checkImageValid('atteducation_back')" value="" required autofocus>
                                        </div>
                                    </div>
                                </student-document-option>
                            </div>
                                ...
                                <student-document-option-nostrification v-bind:active="{{$bcApplication->kzornot ?? 'true'}}">
                                    <div class="subform col-md-12">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 10px;">
                                            ...
                                            <input id="nostrificationattach" type="file" accept=".jpg, .png, .gif, .webp" class="form-control" @change="checkImageValid('nostrificationattach')" name="nostrificationattach" value="" required autofocus>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <label>{{ __('Back side') }}</label>
                                            ...
                                            <input id="nostrificationattach_back" type="file" accept=".jpg, .png, .gif, .webp" class="form-control" @change="checkImageValid('nostrificationattach_back')" name="nostrificationattach_back" value="" required autofocus>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                            ...
                                            <input id="con_confirm" type="file" accept=".jpg, .png, .gif, .webp" class="form-control" @change="checkImageValid('con_confirm')" name="con_confirm" value="" required autofocus>
                                        </div>
                                    </div>
                        ...
                        <template v-if="isTransfer">
                            ...
                            <div class="form-group">
                                <label for="bcspecialty" class="control-label">{{__('Specialty')}}</label>
                                <div class="col-md-12">
                                    <input id="bcspecialty" type="text" class="form-control" name="transfer_specialty" value="" autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="bctransfer_university" class="control-label">{{__('Higher educational')}}</label>
                                <div class="col-md-12">
                                    <input id="bctransfer_university" type="text" class="form-control" name="transfer_university" value="" autofocus>
                                </div>
                            </div>
