                            ...
                            <form action="" method="post">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check margin-b15">
                                        <input id="exampleRadios1" type="radio" name="referral" v-model="selectedReferral" value="Official site" />
                                        <label class="form-check-label" for="exampleRadios1">
                                            {{ __('Official site') }}
                                        </label>
                                    </div>
                                    <div class="form-check margin-b15">
                                        <input id="exampleRadios2" type="radio" name="referral" v-model="selectedReferral" value="Social networks" />
                                        <label class="form-check-label" for="exampleRadios2">
                                            {{ __('Social networks') }}
                                        </label>
                                    </div>
                                    <div class="form-check margin-b15">
                                        <input id="exampleRadios3" type="radio" name="referral" v-model="selectedReferral" value="Advertising in the city" />
                                        <label class="form-check-label" for="exampleRadios3">
                                            {{ __('Advertising in the city') }}
                                        </label>
                                    </div>
                                    <div class="form-check margin-b15">
                                        <input id="exampleRadios4" type="radio" name="referral" v-model="selectedReferral" value="Call center" />
                                        <label class="form-check-label" for="exampleRadios4">
                                            {{ __('Call center') }}
                                        </label>
                                    </div>
                                    <div class="form-check margin-b15">
                                        <input id="exampleRadios5" type="radio" name="referral" v-model="selectedReferral" value="Presentation" />
