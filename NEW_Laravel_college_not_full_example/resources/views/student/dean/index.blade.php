                        ...
                        <div class="col-md-8">
                            <ul class="nav nav-tabs">
                                <li class="nav-item @if(!Session::has('flash_message_callback')) active @endif">
                                    <span class="nav-link active" data-toggle="tab" onclick="activeTab = 'notifications'" href="#notifications"> <span @click="setNotificationsCount"> {{ __("Notifications") }} (@{{ notificationsCount }}) </span></span>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="col-12">
                                        ...
                                        @else
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-1">
                                                    <button id="usedSubmit" type="submit" class="btn btn-info">{{__('callback')}}</button>
                                                </div>
                                            </div>
