                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div v-show="loaded && instructionAccept" style="display: none;">
                                ...
                                @if( (count($task->questions) == 0) && ($task->type != App\SyllabusTask::TYPE_ESSAY ) )
                                ...
                                @else
                                    ...
                                    <div class="col-md-12" v-if="list.length > 0">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            @if( $task->type != App\SyllabusTask::TYPE_ESSAY )
                                            ...
                                            @else
                                                ...
                                                <h6 class="text-first-upper">{{__('Add a response file')}}:</h6>

                                                <input @change="processImgFile($event)" ref="file" style="display: none" type="file" />
                                                <button v-if="!profileImage" @click="$refs.file.click()" :disabled="save || timeout" class="btn btn-info margin-t5" type="button">{{__("Upload photo")}}</button>
                                                <button v-if="profileImage"  @click="$refs.file.click()" :disabled="save || timeout" class="btn alert-success margin-t5" type="button">{{__("Upload photo")}}</button>
            ...
            methods: {
                ...
                finishTest: function() {
                    ...
                    axios.post('{{route('sroSaveResult')}}', {
                        ...
                        image_essay: this.profileImage,
                        source_essay: this.profileImgSource
                    })
                ...
                testLimitAnswers: function(currentPage,id){
                    ...
                    if( this.list[currentPage - 1].answer ){
