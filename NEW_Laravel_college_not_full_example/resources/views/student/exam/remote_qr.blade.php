...
@section('title', __('Remote exam QR'))
...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid" id="study-app">
            <div class="p-3 mb-2 bg-info"><h2 class="text-white no-margin">@lang('Remote exam QR')</h2></div>
            ...
            <div class="card shadow-sm p-3 mb-5 bg-white rounded">
                <div class="card-body">
                    ...
                    <input type="button" value="@lang('Send')" class="btn btn-info btn-lg btn-block" v-on:click="startChecking()">
                        ...
                        <div class="col-12">
                            <div v-if="checkingProcess" v-cloak class="text-center">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="numeric_code" class="form-control numeric_code text-center margin-b15" maxlength="6" v-bind:class="{'qr-error': numericError}">
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                checkQr: function () {
                    ...
                    axios.post('{{route('studentRemoteExamQRCheck')}}', {
                        code: this.qrValue
                    })
                        .then(response => {
                            if (response.data.status) {
                                location.href = '{{route('study')}}';
                            } else {
                ...
                sendNumericCode : function () {
                    ...
                    axios.post('{{route('studentRemoteExamNumericCodeCheck')}}', {
