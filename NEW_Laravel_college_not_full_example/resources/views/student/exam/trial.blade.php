        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-sm p-3 mb-5 bg-white rounded">
                <div class="card-body">
                    ...
                    <a href="{{route('studentPayExamTrial', ['id' => $SD->discipline->id])}}" class="btn btn-info btn-lg btn-block margin-b15 @if($lowBalance) disabled @endif" onclick="return confirm('@lang('Do you confirm this purchase?')');">@lang('Pay')</a>
