...
@section('title', __('Appeal Test 1'))
...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid" id="study-app">
            <div class="p-3 mb-2 bg-info"><h2 class="text-white no-margin">@lang('Appeal Test 1')</h2></div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <form method="post" action="{{route('studentTest1Appeal', ['disciplineId' => $discipline->id])}}" enctype="multipart/form-data">
                                {{csrf_field()}}
