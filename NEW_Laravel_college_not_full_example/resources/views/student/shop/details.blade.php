...
@section('shop-content')
    ...
    <div class="col-md-9">
        ...
        <div class="col-md-3">{{ __('Language') }}:</div><div class="col-md-9">{{ $course->language }}</div>
        <div class="col-md-3">{{ __('Teacher') }}:</div>
        <div class="col-md-9">
    ...
    <div class="col-md-12">
        <hr>
        <h4>{{ $lecture->title }}</h4>
        <div class="col-md-12" style="margin-bottom: 10px;">{{ $lecture->description }}</div>
        <div class="col-md-4">
        ...
        @if($course->discipline || (!$course->discipline && count($lecture->students) ))
            ...
            @if(isset($lecture->room->id) &&
             ...
             <div class="col-md-12">{{ __('Address') }}: {{ $lecture->room->building->name . ', ' . __('Floor') . ' ' . $lecture->room->floor . ', ' . __('Room') . ' №' . $lecture->room->number}}</div>
            @endif
        @endif
