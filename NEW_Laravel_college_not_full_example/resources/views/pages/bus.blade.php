...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="p-3 mb-2 bg-info"> <h2 class="text-white no-margin"> {{__('Bus')}} </h2> </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <video class="col-12 margin-t20 margin-b20" loop autoplay controls="true" muted="muted" preload="true" poster="{{ URL::asset('assets/video/miras_bus.jpg') }}">
