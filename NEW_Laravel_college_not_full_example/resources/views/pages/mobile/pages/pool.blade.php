        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-sm p-3 mb-5 bg-white rounded">
                <div class="card-body">
                    ...
                    <video class="col-12 margin-t20 margin-b20" loop autoplay playsinline controls="true" width="100%" height="100%" muted="muted" preload="true" poster="{{ URL::asset('assets/video/pool.jpg') }}">
