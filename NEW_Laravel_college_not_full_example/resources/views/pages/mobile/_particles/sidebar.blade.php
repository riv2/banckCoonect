...
<aside class="main-sidebar sidebar-dark-primary elevation-4" id="sidebaring">
    <!-- Brand Logo -->
    <a href="/" class="brand-link">
        <img class="miras-sidebar-logo" src="{{ URL::asset('lte_assets/img/logo.png') }}" alt="{{getcong('site_name')}}" />
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                @if(\App\Services\Auth::check())
                    ...
                    <li class="nav-item">
                        <a href="{{route('studentEnt')}}" class="nav-link {{ \App\Services\SidebarMenuActive::isActive('studentEnt') }}">
                    ...
                    <li class="nav-item">
                        <a href="/{{Config::get('chatter.routes.home')}}" class="nav-link {{ \App\Services\SidebarMenuActive::isActive('chatter.home') }}">
