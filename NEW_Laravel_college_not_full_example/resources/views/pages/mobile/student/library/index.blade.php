                ...
                <div class="col-md-6">
                    {!! Form::open([
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="search" placeholder="поиск" aria-label="Search" id="searchInput" value="{{ request()->get('search')?? '' }}">
                        </div>
                    {!! Form::close() !!}
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @else
                                            <a href="#" class="btn btn-primary disabled">Скачать</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
