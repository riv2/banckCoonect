        ...
        <div class="container-fluid" id="main-container">
            ...
            <div class="card shadow-sm p-3 mb-5 bg-white rounded">
                <div class="card-body">
                    ...
                    <form autocomplete="off" id="application-form" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        @yield('part')

                        <div class="form-group text-right">
                            <button v-bind:disabled="entActive && activePage == 'ent'" type="submit" class="btn btn-info btn-lg">{{ __('Continue') }}</button>
                        </div>
