        ...
        <student-education-block name="education-block" v-bind:active="true">
            <div class="col-md-12 subform">
                ...
                <div class="form-group padding-t15">
                    <div class="col-md-8">
                            <a style="margin-right:10px;" class="btn btn-link margin-b15" v-bind:class="educationLevel == 'high_school' ? 'btn-info text-white' : 'btn-default'" v-on:click="educationLevel = 'high_school'">{{__('High school')}}</a>
                            <a style="margin-right:10px;" class="btn btn-link margin-b15" v-bind:class="educationLevel == 'vocational_education' ? 'btn-info text-white' : 'btn-default'" v-on:click="educationLevel = 'vocational_education'">{{__('Vocational education')}}</a>
                            <a class="btn btn-link margin-b15" v-bind:class="educationLevel == 'bachelor' ? 'btn-info text-white' : 'btn-default'" v-on:click="educationLevel = 'bachelor'">{{__('Bachelor')}}</a>
                        ...
                        <div v-if="educationLevel" class="col-md-12 subform">
                            ...
                            <div class="form-group">
                                <label for="with_honors" class="control-label">{{__('With honors')}}</label>
                                <input id="with_honors" type="checkbox" name="with_honors" value="1">
                            </div>

                            <div class="form-group">
                                <label for="is_transfer" class="control-label">{{__('Is transfer')}}</label>
