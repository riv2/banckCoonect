                ...
                <div class="card-body">
                    ...
                    <div class="margin-b20">
                        ...
                        @if(false)
                            ...
                            <a role="button" class="btn btn-info btn-lg btn-block" href="{{route('remoteAccessPay', ['id' => $studentDiscipline->discipline->id, 'test' => 'test1'])}}">@lang('Take the test remotely')</a>
                        @endif
                    </div>
...
@section('scripts')
    <script type="text/javascript">
        const DISCIPLINE_ID = '{{$studentDiscipline->discipline->id}}';
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                checkQr: function () {
                    ...
                    axios.post('{{route('studentTest1QRCheck')}}', {
                        code: this.qrValue,
                        discipline_id: DISCIPLINE_ID
                    })
                        .then(response => {
                            if (response.data.status) {
                                location.href = '{{route('studentQuiz', ['id' => $studentDiscipline->discipline->id])}}';
                            } else {
                ...
                sendNumericCode : function () {
                    ...
                    axios.post('{{route('studentTest1NumericCodeCheck')}}', {
