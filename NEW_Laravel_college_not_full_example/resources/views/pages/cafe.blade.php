                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <video class="col-12 margin-t20 margin-b20" loop autoplay controls="true" width="100%" height="100%" muted="muted" preload="true" poster="{{ URL::asset('assets/video/hall.jpg') }}">
