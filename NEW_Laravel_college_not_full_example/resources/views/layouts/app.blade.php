...
<script type="text/javascript">
    ...
    const bviLocalization = {
        "Font size": "@lang('Font size')",
        "Site colors": "@lang('Site colors')",
        "Images": "@lang('Images')",
        "Additionally": "@lang('Additionally')",
        "Settings": "@lang('Settings')",
        "Line space": "@lang('Line space')",
        "Standard": "@lang('Standard')",
        "Medium": "@lang('Medium')",
        "Large": "@lang('Large')",
        "Letter space": "@lang('Letter space')",
        "Single": "@lang('Single')",
        "One and a half": "@lang('One and a half')",
        "Double": "@lang('Double')",
        "Font": "@lang('Font')",
        "Sans serif": "@lang('Sans serif')",
        "Serif": "@lang('Serif')",
        "Enable frames": "@lang('Enable frames')",
        "Disable frames": "@lang('Disable frames')",
        "Settings by default": "@lang('Settings by default')",
        "Close": '@lang('Close')'
    }
</script>
...
@if( env('APP_DEBUG') === false )
    <script src="{{ URL::asset('assets/js/vue-product.min.js') }}"></script>
@else
...
<script src="{{ URL::asset('bvi.isvek/js/bvi.js') }}"></script>
