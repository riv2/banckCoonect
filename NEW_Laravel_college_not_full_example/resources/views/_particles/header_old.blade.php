                        ...
                        <!-- Right Side Of Navbar -->
                            ...
                            <ul class="nav navbar-nav navbar-expand-lg">
                                ...
                                @if(\App\User::getCurrentRole() == \App\Role::NAME_CLIENT)
                                    ...
                                    <li><a href="{{ route('financesPanel') }}">{{__('Cabinet')}}</a></li>
                                ...
                                @elseif(\App\User::getCurrentRole() == \App\Role::NAME_TEACHER)
                                    <li><a href="{{ route('teacher.journal.index') }}">@lang('Journal')</a></li>
                                    <li><a href="{{ route('chatter.home') }}">@lang('Forum')</a></li>
                                    <li><a href="{{ route('teacherProfile') }}">{{__('Profile Teacher')}}</a></li>
                                    <li><a href="{{ route('teacherQrGenerate') }}">{{__('QR generate')}}</a></li>
                                    @if(in_array(Auth::user()->id, \App\QrCode::$adminTeachers))
                                        <li><a href="{{ route('teacherQRForTest') }}">{{__('QR for Test')}}</a></li>
                                    @endif
                                @endif
