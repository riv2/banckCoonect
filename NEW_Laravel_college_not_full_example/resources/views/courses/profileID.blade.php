                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <form class="col-12" method="POST" enctype="multipart/form-data" action="{{ route('courseProfileIdPost') }}">
                            ...
                            <small>{{__("No ID RK or enter manually? You need")}} <a href="{{ route('courseProfileIdManual') }}">{{__("here")}}</a></small>
