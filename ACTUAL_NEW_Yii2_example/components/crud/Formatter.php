...
class Formatter extends \netis\crud\web\Formatter
{
     ...
     * @var string
     */
    public $dbTimeZone = 'Europe/Kiev';
    public $defaultTimeZone = 'Europe/Kiev';
    ...
    public function asUuid($value, $options = [], $action = 'view', $label = null) {
        return $this->asCrudLink($value, $options, $action, $label);
    }
