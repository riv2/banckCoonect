    ...
    private function linkDirectByKeys($relation, $keys, $removeKeys = null)
    {
        ...
        if (!empty($keys) || !empty($removeKeys)) {
            ...
            $where = [
                'and',
                $removeKeys === null
                    ? $this->buildKeyInCondition('not in', $relatedClass::getTableSchema()->id, $keys)
                    : $this->buildKeyInCondition('in', $relatedClass::getTableSchema()->id, $removeKeys),
        ...
        $owner::getDb()->createCommand()
            ->update(
                ...
                [
                    'and',
                    $this->buildKeyInCondition('in', $relatedClass::getTableSchema()->id, $keys),
